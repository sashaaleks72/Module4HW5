...
namespace Module4HW4.Migrations
{
    ...
    [Migration("20220716221847_InitialOrderTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkingWithDB.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2022, 7, 17, 1, 18, 46, 533, DateTimeKind.Local).AddTicks(3891),
                            OrderStatusId = 1,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            OrderDate = new DateTime(2022, 7, 17, 1, 18, 46, 533, DateTimeKind.Local).AddTicks(3937),
                            OrderStatusId = 2,
                            UserId = 3
                        },
                        new
                        {
                            Id = 3,
                            OrderDate = new DateTime(2022, 7, 17, 1, 18, 46, 533, DateTimeKind.Local).AddTicks(3941),
                            OrderStatusId = 2,
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("WorkingWithDB.Models.User", b =>
                {
                    b.HasOne("WorkingWithDB.Models.Role", "Role")
                        .WithMany("Users")
